...
public class SimpleNoteWidgetProvider_3_2 extends AppWidgetProvider {
    ...
    private void addItem(Context context, int appWidgetId, RemoteViews remoteViews, ListItemElement item) {
        ...
        this.setEventBroadcast(context, SimpleNoteWidgetProvider_3_2.class, newView, Constants.ACTION_WIDGET_UPDATE_FROM_WIDGET_READY_ITEM, appWidgetId, itemId, R.id.widget_layout_row_text);
    }
